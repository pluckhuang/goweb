...
import (
	...
	"github.com/pluckhuang/goweb/aweb/search/test/startup"
...
func (s *SearchTestSuite) TestSearch() {
	...
	assert.Equal(s.T(), 3, len(articles))
...
// es 查看所有索引:   http://localhost:9200/_cat/indices?v
// es 查看索引doc :  http://localhost:9200/article_index/_search?pretty
