...
const file_feed_v1_feed_proto_rawDesc = "" +
	"\n" +
	"\x12feed/v1/feed.proto\x12\afeed.v1\"\x16\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x0eFindFeedEvents\x12\x1e.feed.v1.FindFeedEventsRequest\x1a\x1f.feed.v1.FindFeedEventsResponseB\x94\x01\n" +
	"\vcom.feed.v1B\tFeedProtoP\x01Z=github.com/pluckhuang/goweb/aweb/api/proto/gen/feed/v1;feedv1\xa2\x02\x03FXX\xaa\x02\aFeed.V1\xca\x02\aFeed\\V1\xe2\x02\x13Feed\\V1\\GPBMetadata\xea\x02\bFeed::V1b\x06proto3"
